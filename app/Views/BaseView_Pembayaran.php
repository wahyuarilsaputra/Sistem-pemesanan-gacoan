                ...
                <div class="table-responsive">
                    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td><?= $item['jumlah'] ?></td>
                            <td>Rp <?= number_format(intval($item['harga']) * intval($item['jumlah']), 0, ',', '.') ?></td>
                            <td>
                                <a href="<?php echo base_url('/pembayaran/hapus/'.$item['nama_menu']); ?>">
                        ...
                        <tfoot>
                            ...
                            <td>
                                <a href="<?php echo base_url('/pembayaran/bayar/'); ?>" data-toggle="modal" data-target="#bayarModal">
