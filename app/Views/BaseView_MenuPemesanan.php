                        ...
                        <div class="col-sm-3">
                            ...
                            <img class="card-img-top" style="width:250px;height:250px;object-fit: cover;" src="<?php echo base_url('/template/img/'.$tampil->gambar);?>" alt="Card image cap">
                                <div class="card-body col-sm-12">                                    
                                    ...
                                    <?php if($tampil->status == "tidak") {?>
                                        <button type="button" class="btn btn-danger col-sm-12">Habis</button>
                                    <?php }
                                    else { ?>
                                        <a href="<?php echo base_url('/pemesanan/pesan/'.$tampil->id_menu); ?>">
                                            <button type="button" class="btn btn-secondary col-sm-12">Pesan</button>
                                        </a>
                                    <?php } ?>
                                </div>
                            </div>
