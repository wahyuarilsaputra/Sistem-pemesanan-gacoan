...
<body class="bg-gradient-primary" style="background-image: url('<?=base_url()?>/template/img/bg_login.jpg');">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-10">
                        ...
                        <div class="col-lg-6 d-none d-lg-block">
                                <img src="<?=base_url()?>/template/img/logo_login2.png" alt="" style="width:100%;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
